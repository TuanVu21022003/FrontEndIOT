...
import { COLOR_WATER, HEIGHT_POOL, HEIGHT_WAVY, INSET_POOL, WIDTH_POOL } from '../../Assets/Constants/constants';
...
const Pool = ({ ratio }) => {
    ...
    useEffect(() => {
        ...
        const updatedHeight = ratio * (HEIGHT_POOL - 2 * INSET_POOL - HEIGHT_WAVY / 7);
